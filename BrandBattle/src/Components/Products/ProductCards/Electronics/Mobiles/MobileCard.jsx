...
function MobileCard({ mobile }) {
    return (
        ...
        >
            ...
            <h2 className="text-xl font-bold text-white mt-4">{mobile.name}</h2>
            <p className="text-sm text-cyan-100 mt-2">{mobile.description}</p>

            <div className="flex justify-between items-center mt-4 text-white">
                <span className="text-lg font-bold">{mobile.price}</span>
                <span className="text-yellow-400">⭐ {mobile.rating}</span>
            </div>
